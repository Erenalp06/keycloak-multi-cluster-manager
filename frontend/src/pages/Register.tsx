...
import { AlertCircle, User, Lock, Mail, CheckCircle2 } from 'lucide-react';
    ...
    <div className="flex h-screen overflow-hidden bg-[#0a0e27]">
      ...
      <div className="flex-1 flex items-center justify-center bg-white relative">
        <div className="w-[440px] animate-fadeInUp">
          ...
          {/* Register Header */}
          <div className="mb-8">
            <h1 className="text-[28px] font-bold text-[#0a0e27] mb-2 tracking-tight">Create Account</h1>
            <p className="text-[15px] text-slate-500">Sign up to get started with Keyclock</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className={`w-full py-3.5 rounded-lg font-semibold text-[15px] tracking-wide transition-all mt-6 ${
                isRegistered
            ...
            <div className="text-center text-sm text-slate-600">
              ...
              <Link to="/login" className="font-semibold text-[#1a1f3a] hover:text-[#0a0e27] transition-colors">
                Sign In
              </Link>
            </div>
